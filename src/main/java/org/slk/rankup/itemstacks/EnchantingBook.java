...
public class EnchantingBook {
    ...
    public enum ModifierType { EFFICIENCY, FORTUNE, UNBREAKABLE }
    public static ItemStack COMMON_SKULL = ItemStackBuilder.getSkull("http://textures.minecraft.net/texture/d53fa1b57e4f784d16e5a2daa2f746b2ecfe624ccd74a4d4acc6a2e6a083f54e", UUID.fromString("0041a162-ad10-4dfc-906d-014c797abaeb"));
    public static ItemStack UNCOMMON_SKULL = ItemStackBuilder.getSkull("http://textures.minecraft.net/texture/1c030cc35fde0218ded5ba5d557cca9e03dcbc84f9e672911da54fe07c5fdbbb", UUID.fromString("7a6f8374-8915-43db-acdf-932da0dbcd25"));
    public static ItemStack RARE_SKULL = ItemStackBuilder.getSkull("http://textures.minecraft.net/texture/93a69c3caa31304e9952328c72cee0b57b2a2bd46ce9c5cb88c07d1266277d6a", UUID.fromString("a71300d1-7286-4f84-aee1-fce55c7bb172"));
