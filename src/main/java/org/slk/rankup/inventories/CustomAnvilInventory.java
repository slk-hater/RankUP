package org.slk.rankup.inventories;
...
public class CustomAnvilInventory {
    ...
    public static List<Integer> EMPTY_SLOTS = new ArrayList<>(List.of(3, 4, 5, 19, 22, 24, 40));
    ...
    static{
        ...
        inv.setItem(5, ItemStackBuilder.build(Material.TNT_MINECART, 1, "&eDestruir item", "&8Clica para destruir o item"));
    }
